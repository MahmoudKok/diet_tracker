...
class CustomLoadingButtonAndListOfCardsScreen extends StatelessWidget {
  const CustomLoadingButtonAndListOfCardsScreen({super.key});
      ...
      child: Column(
        children: [
          ...
          SkeletonizerContainer(
            ...
            width: 1.sw,
            roundnessLevel: RoundnessLevel.low,
            child: const SearchFiltersSectionLoading(),
          ),
          14.verticalSpace,
          ListView.builder(
            shrinkWrap: true,
